...
export class PruebaComponent implements OnInit {
  ...
  docs: Array<any> = [
    ...
    {
      name: "Cédula de ciudadanía venezolana",
      value: "Cédula de ciudadanía venezolana",
    },
    { name: "PPT", value: "PPT" },
  ...
  onCheckboxChange(event: any) {
    const docsSeleccionados = this.fgValidator.controls[
      "docsSeleccionados"
    ] as FormArray;
  ...
  ngOnInit(): void {
    this.preguntas = {
      ...
      6: {
        Descripcion:
          "4. De acuerdo con su cultura, pueblo o rasgos físicos; usted se auto reconoce como?",
        Tipo: "select",
        NoOp: ["Mestizo", "Afrodescendiente", "Indígena", "Otro"],
      },
      7: {
        Descripcion: "5. ¿Cuál es su identidad de género?",
        Tipo: "select",
        NoOp: ["Hombre", "Mujer", "Hombre trans", "Mujer trans", "Otro"],
      },
      8: {
        Descripcion:
      ...
      (datos: ModelSurvey) => {
        ...
        if (
          ...
          (dataEncu.datos.id == Object.values(datos)[0].usuarioId ||
            dataEncu.datos.rol == "administrador")
        ) {
          Swal.fire({
