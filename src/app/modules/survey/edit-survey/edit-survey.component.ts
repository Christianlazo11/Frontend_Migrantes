...
export class EditSurveyComponent implements OnInit {
  ...
  lista: string[] = [
    "Ha recibido apoyo del sector Salud",
    "Ha recibido apoyo del sector educacion",
    "Ha recibido apoyo de Migracion Colombia",
    "Ha recibido apoyo de Min.Trabajo",
    "Ha recibido apoyo de la Alcaldia",
  ...
  SISeleccionados = this.fgValidator.controls[
    "servicios_institucionales"
  ] as FormArray;
  PSISeleccionados = this.fgValidator.controls[
    "servicios_institucionales"
  ] as FormArray;
  TNBSeleccionados = this.fgValidator.controls[
    "tipo_necesidad_basica"
  ] as FormArray;
  TARIESeleccionados = this.fgValidator.controls[
    "tipo_ayuda_recibida_IE"
  ] as FormArray;
  TARCISeleccionados = this.fgValidator.controls[
    "tipo_ayuda_recibida_CI"
  ] as FormArray;
  SERSeleccionados = this.fgValidator.controls[
    "situa_especial_retornado"
  ] as FormArray;
  ASDVSeleccionados = this.fgValidator.controls[
    "ajuste_socio_demo_vene"
  ] as FormArray;
  ...
  servInsti: Array<any> = [
    {
      name:
        "¿Sector salud le ha brindado atencion médica, hospitalaria y de vacunacion?",
      value: "0",
    },
    {
      name: "¿Sector educacion, le ha permitido que sus hijos estudien?",
      value: "1",
    },
    {
      name: "¿Migración Colombia, le ha brindado atención oportuna y eficiente",
      value: "2",
    },
    {
      name:
        "¿Min.del Trabajo, le ha brindado apoyo en solución de conflictos laborales",
      value: "3",
    },
    {
      name:
        "¿La alcaldía a través de la Sec. de Gobierno le ha brindado apoyo y orientacion requerida.?",
      value: "4",
    },
    {
      name:
        "¿Las ONGs nacionales e internacionales, le han brindado el apoyo y/o cooperación o ayuda humanitaria?",
      value: "5",
    },
  ...
  onCheckboxChangeSI(event: any) {
    if (event.target.checked) {
      ...
      const index = this.SISeleccionados.controls.findIndex(
        (x) => x.value === event.target.value
      );
  ...
  onCheckboxChangeTNB(event: any) {
    if (event.target.checked) {
      ...
      const index = this.TNBSeleccionados.controls.findIndex(
        (x) => x.value === event.target.value
      );
  ...
  onCheckboxChangeTARIE(event: any) {
    if (event.target.checked) {
      ...
      const index = this.TARIESeleccionados.controls.findIndex(
        (x) => x.value === event.target.value
      );
  ...
  onCheckboxChangeTARCI(event: any) {
    if (event.target.checked) {
      ...
      const index = this.TARCISeleccionados.controls.findIndex(
        (x) => x.value === event.target.value
      );
  ...
  situaEspecialRetornado: Array<any> = [
    ...
    {
      name: "d) Las Instituciones del Estado le han brindado apoyo",
      value: "3",
    },
  ...
  onCheckboxChangeSER(event: any) {
    if (event.target.checked) {
      ...
      const index = this.SERSeleccionados.controls.findIndex(
        (x) => x.value === event.target.value
      );
  ...
  onCheckboxChangeASDV(event: any) {
    if (event.target.checked) {
      ...
      const index = this.ASDVSeleccionados.controls.findIndex(
        (x) => x.value === event.target.value
      );
  ...
  ngOnInit(): void {
    ...
    this.SerchSurvey(
      this.ServInstiSeleccionados,
      this.TipoNeceBasicaSeleccionados,
      this.TipoAyuRecibidaIESeleccionados,
      this.TipoAyuRecibidaCISeleccionados,
      this.SituaEspeRetornadoSeleccionados,
      this.AjuSocioDemoVeneSeleccionados
    );
    this.GetListPeople();

    this.serviceSurvey
      .GetData(this.noEncu.replace(":", ""))
      .subscribe((datos: ModelSurvey) => {
        for (
          let i = 0;
          i <
          Number(
            Object.values(datos)[0].servicios_institucionales?.split(",").length
          );
          i++
        ) {
          this.SISeleccionados.push(
            new FormControl(
              Object.values(datos)[0].servicios_institucionales?.split(",")[i]
            )
          );
        }
        ...
        for (
          ...
          i <
          Number(
            Object.values(datos)[0].tipo_necesidad_basica?.split(",").length
          );
          i++
        ) {
          this.TNBSeleccionados.push(
            new FormControl(
              Object.values(datos)[0].tipo_necesidad_basica?.split(",")[i]
            )
          );
        }
        ...
        for (
          ...
          i <
          Number(
            Object.values(datos)[0].tipo_ayuda_recibida_IE?.split(",").length
          );
          i++
        ) {
          this.TARIESeleccionados.push(
            new FormControl(
              Object.values(datos)[0].tipo_ayuda_recibida_IE?.split(",")[i]
            )
          );
        }
        ...
        for (
          ...
          i <
          Number(
            Object.values(datos)[0].tipo_ayuda_recibida_CI?.split(",").length
          );
          i++
        ) {
          this.TARCISeleccionados.push(
            new FormControl(
              Object.values(datos)[0].tipo_ayuda_recibida_CI?.split(",")[i]
            )
          );
        }
        ...
        for (
          ...
          i <
          Number(
            Object.values(datos)[0].situa_especial_retornado?.split(",").length
          );
          i++
        ) {
          this.SERSeleccionados.push(
            new FormControl(
              Object.values(datos)[0].situa_especial_retornado?.split(",")[i]
            )
          );
        }
        ...
        for (
          ...
          i <
          Number(
            Object.values(datos)[0].ajuste_socio_demo_vene?.split(",").length
          );
          i++
        ) {
          this.ASDVSeleccionados.push(
            new FormControl(
              Object.values(datos)[0].ajuste_socio_demo_vene?.split(",")[i]
            )
          );
        }
      });
  ...
  SerchSurvey(
    ...
    this.serviceSurvey.GetData(this.noEncu.replace(":", "")).subscribe(
      (datos: ModelSurvey) => {
        ...
        console.log(
          "Tipo de ayuda recibida IE: " +
            Object.values(datos)[0].tipo_ayuda_recibida_IE.length
        );
        console.log(
          "Tipo de ayuda recibida CI: " +
            Object.values(datos)[0].tipo_ayuda_recibida_CI.length
        );
        console.log(
          "Nececidad basica: " +
            Object.values(datos)[0].tipo_necesidad_basica.length
        );

        this.fgValidator.controls["municipio"].setValue(
          Object.values(datos)[0].municipio
        );
        this.fgValidator.controls["direccion"].setValue(
          Object.values(datos)[0].direccion
        );
        this.fgValidator.controls["correo"].setValue(
          Object.values(datos)[0].correo
        );
        this.fgValidator.controls["tel"].setValue(
          Object.values(datos)[0].fijo_cel
        );
        this.fgValidator.controls["est_civil"].setValue(
          Object.values(datos)[0].est_civil
        );
        this.fgValidator.controls["info_nucleo"].setValue(
          Object.values(datos)[0].info_nucleo
        );
        this.fgValidator.controls["conf_hogar"].setValue(
          Object.values(datos)[0].conf_hogar
        );
        this.fgValidator.controls["quedaron_hijos"].setValue(
          Object.values(datos)[0].quedaron_hijos
        );
        this.fgValidator.controls["nacionalidad_pareja"].setValue(
          Object.values(datos)[0].nacionalidad_pareja
        );
        this.fgValidator.controls["razon_cruce"].setValue(
          Object.values(datos)[0].razon_cruce
        );

        this.fgValidator.controls["tiempo_estancia"].setValue(
          Object.values(datos)[0].tiempo_estancia
        );
        this.fgValidator.controls["razon_arauca"].setValue(
          Object.values(datos)[0].razon_arauca
        );
        this.fgValidator.controls["intencion"].setValue(
          Object.values(datos)[0].intencion
        );
        this.fgValidator.controls["intencion_permanecer"].setValue(
          Object.values(datos)[0].intencion_permanecer
        );
        this.fgValidator.controls["localidad_procedencia"].setValue(
          Object.values(datos)[0].localidad_procedencia
        );
        this.fgValidator.controls["maternidad"].setValue(
          Object.values(datos)[0].maternidad
        );
        this.fgValidator.controls["apostillo_tit_bachiller"].setValue(
          Object.values(datos)[0].apostillo_tit_bachiller
        );
        this.fgValidator.controls["apostillo_tit_tec"].setValue(
          Object.values(datos)[0].apostillo_tit_tec
        );
        this.fgValidator.controls["apostillo_tit_profesional"].setValue(
          Object.values(datos)[0].apostillo_tit_profesional
        );
        this.fgValidator.controls["apostillo_otro_titulo"].setValue(
          Object.values(datos)[0].apostillo_otro_titulo
        );

        this.fgValidator.controls["lugar_trabajo"].setValue(
          Object.values(datos)[0].lugar_trabajo
        );
        this.fgValidator.controls["posicion_trabajo"].setValue(
          Object.values(datos)[0].posicion_trabajo
        );
        this.fgValidator.controls["tipo_vinculacion"].setValue(
          Object.values(datos)[0].tipo_vinculacion
        );
        this.fgValidator.controls["obtener_ingresos"].setValue(
          Object.values(datos)[0].obtener_ingresos
        );
        this.fgValidator.controls["ingresos_mensuales"].setValue(
          Object.values(datos)[0].ingresos_mensuales
        );
        this.fgValidator.controls["invierte_salario"].setValue(
          Object.values(datos)[0].invierte_salario
        );
        this.fgValidator.controls["intencion_tiempo_estancia"].setValue(
          Object.values(datos)[0].intencion_tiempo_estancia
        );
        this.fgValidator.controls["interes_salud_publica"].setValue(
          Object.values(datos)[0].interes_salud_publica
        );
        this.fgValidator.controls["institucion_cubrio_gastos"].setValue(
          Object.values(datos)[0].institucion_cubrio_gastos
        );

        for (
          let i = 0;
          i <
          Number(Object.values(datos)[0].servicios_institucionales.length - 1);
          i++
        ) {
          ServInstiSeleccionados.push(
            Number(
              Object.values(datos)[0].servicios_institucionales.split(",")[i]
            )
          );
        ...
        for (
          let i = 0;
          i < Number(Object.values(datos)[0].tipo_necesidad_basica.length - 1);
          i++
        ) {
          TipoNeceBasicaSeleccionados.push(
            Number(Object.values(datos)[0].tipo_necesidad_basica.split(",")[i])
          );
        }

        for (
          let i = 0;
          i < Number(Object.values(datos)[0].tipo_ayuda_recibida_IE.length - 1);
          i++
        ) {
          TipoAyuRecibidaIESeleccionados.push(
            Number(Object.values(datos)[0].tipo_ayuda_recibida_IE.split(",")[i])
          );
        }

        for (
          let i = 0;
          i < Number(Object.values(datos)[0].tipo_ayuda_recibida_CI.length - 1);
          i++
        ) {
          TipoAyuRecibidaCISeleccionados.push(
            Number(Object.values(datos)[0].tipo_ayuda_recibida_CI.split(",")[i])
          );
        }
        ...
        for (
          let i = 0;
          i <
          Number(Object.values(datos)[0].situa_especial_retornado.length - 1);
          i++
        ) {
          SituaEspeRetornadoSeleccionados.push(
            Number(
              Object.values(datos)[0].situa_especial_retornado.split(",")[i]
            )
          );
        ...
        for (
          let i = 0;
          i < Number(Object.values(datos)[0].ajuste_socio_demo_vene.length - 1);
          i++
        ) {
          AjuSocioDemoVeneSeleccionados.push(
            Number(Object.values(datos)[0].ajuste_socio_demo_vene.split(",")[i])
          );
        }

        // console.log(ServInstiSeleccionados)

        this.fgValidator.controls["miselect"].setValue(
          Object.values(datos)[0].miselect
        );
        this.fgValidator.controls["clase_vivienda"].setValue(
          Object.values(datos)[0].clase_vivienda
        );
        this.fgValidator.controls["tipo_vivienda"].setValue(
          Object.values(datos)[0].tipo_vivienda
        );
        this.fgValidator.controls["causal_de_retorno"].setValue(
          Object.values(datos)[0].causal_de_retorno
        );

        this.fgValidator.controls["años_estancia_vzla"].setValue(
          Object.values(datos)[0].años_estancia_vzla
        );
      },
      (error) => {
  ...
  SavePerson() {
    ...
    this.serviceSurvey.GetData(this.noEncu.replace(":", "")).subscribe(
      (datos: ModelSurvey) => {
        ...
        let tipo_emprendimiento = this.fgPersona.controls["tipo_emprendimiento"]
          .value;
        let act_economica = this.fgPersona.controls["act_economica"].value;
        let tipo_act_economica = this.fgPersona.controls["tipo_act_economica"]
          .value;
        let runv = this.fgPersona.controls["runv"].value;
        let estatus_migratorio = this.fgPersona.controls["estatus_migratorio"]
          .value;
        let afiliacion_salud = this.fgPersona.controls["afiliacion_salud"]
          .value;
        //Tipo de Documento
        let docsSeleccionados: string[] = this.fgPersona.value
          .docsSeleccionados;
        let discapacidad = this.fgPersona.controls["discapacidad"].value;
        let grupo_etnico = this.fgPersona.controls["grupo_etnico"].value;
        let movilidad_migratoria = this.fgPersona.controls[
          "movilidad_migratoria"
        ].value;
        ...
        console.log(
          "los documentos seleccionados son de tipo " + typeof docsSeleccionados
        );
        ...
        this.servicePerson.CreatePerson(newPerson).subscribe(
          (datos: ModelPerson) => {
            ...
            this.router.navigate([
              `/encuesta/editar-encuesta/${this.noEncu.replace(":", "")}`,
            ]);
  ...
  ModificarEncuesta() {
    ...
    let intencion_permanecer = this.fgValidator.controls["intencion_permanecer"]
      .value;
    let localidad_procedencia = this.fgValidator.controls[
      "localidad_procedencia"
    ].value;
    let maternidad = this.fgValidator.controls["maternidad"].value;
    let apostillo_tit_bachiller = this.fgValidator.controls[
      "apostillo_tit_bachiller"
    ].value;
    let apostillo_tit_tec = this.fgValidator.controls["apostillo_tit_tec"]
      .value;
    let apostillo_tit_profesional = this.fgValidator.controls[
      "apostillo_tit_profesional"
    ].value;
    let apostillo_otro_titulo = this.fgValidator.controls[
      "apostillo_otro_titulo"
    ].value;
    ...
    let ingresos_mensuales = this.fgValidator.controls["ingresos_mensuales"]
      .value;
    let invierte_salario = this.fgValidator.controls["invierte_salario"].value;
    let intencion_tiempo_estancia = this.fgValidator.controls[
      "intencion_tiempo_estancia"
    ].value;
    let interes_salud_publica = this.fgValidator.controls[
      "interes_salud_publica"
    ].value;
    let institucion_cubrio_gastos = this.fgValidator.controls[
      "institucion_cubrio_gastos"
    ].value;
    ...
    let causal_de_retorno = this.fgValidator.controls["causal_de_retorno"]
      .value;
    let años_estancia_vzla = this.fgValidator.controls["años_estancia_vzla"]
      .value;
